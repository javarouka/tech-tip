...
이렇게 데이터를 최대한 분할하여 재활용성과 서버 자원 낭비를 줄이고 성능 향상도 고려해보기로 했다. 물론 모든 데이터를 토막치는게 아닌 비즈니스나 UI 상황, 효율및 결합도에 따라 데이터 구성을 하여 합치기로 했다.

마침 적용하려고 하는 상태관리기 [Redux](https://lunit.gitbook.io/redux-in-korean/) 의 selector 개념과 이를 보좌해주는 [Reselect](https://github.com/reduxjs/reselect) 는 이런 방식에 찰떡 궁합이다.
...
기회가 된다면 Spring Boot 부터 Mbean 등을 좀 더 잘 써보고 싶은데, 새 프로젝트에나 도입해야 할 것 같아서 아쉽다.
